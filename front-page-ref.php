  ...
  <body class="font-sans text-gray-800 bg-gray-50">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
          <div class="flex items-center">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/lilotCalinsLogo.png" alt="Logo L'îlot Câlins" class="hidden md:block h-22 w-auto p-1" />
          </div>
    ...
    <main>
      ...
      <header class="relative bg-white overflow-hidden">
        <div class="max-w-7xl mx-auto">
          <div
            ...
            <div class="sm:text-center lg:text-left">
              ...
              <h1
                class="font-title text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl leading-tight">
        ...
        <!-- Espace pour une photo poignante mais digne (pas de misérabilisme) -->
            ...
            <div
              ...
              <h2 class="text-3xl font-bold mb-4">
                ...
                <p class="text-brand-blue-100 text-lg mb-8 opacity-90">
                  L'îlot Câlins finance en urgence les opérations chirurgicales, les
                  traitements lourds et le matériel médical pour les enfants dont
                  les familles n'ont pas les moyens.
                </p>
      ...
      <!-- SECTION ENFANTS (Lien émotionnel) -->
      <section id="enfants" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="text-center max-w-3xl mx-auto mb-16">
            <h2 class="text-3xl font-extrabold text-gray-900 sm:text-4xl">
              <h2 class="font-title text-3xl font-extrabold text-gray-900 sm:text-4xl">
                Ils ont besoin de vous maintenant
              </h2>
              <p class="mt-4 text-xl text-gray-500">
                Derrière chaque appel aux dons se cache le visage d'un enfant dont
              ...
              <div class="p-6">
                <div class="flex justify-between items-baseline mb-2">
                  <h3 class="text-2xl font-bold text-gray-900">
                    <h3 class="font-title text-2xl font-bold text-gray-900">
                      Amadou,
                      <span class="text-lg font-normal text-gray-500">4 ans</span>
                    </h3>
                </div>
                <p class="text-brand-blue font-semibold text-sm mb-4">
                  📍 Sénégal • Chirurgie cardiaque
                </p>
                <p class="text-gray-600 mb-6 line-clamp-3">
                  Amadou souffre d'une malformation cardiaque sévère. Sans une
                  opération dans les 15 prochains jours, son cœur risque de
                  lâcher. L'hôpital est prêt, il ne manque que le financement.
                </p>
                ...
                <div class="flex justify-between text-sm font-semibold mb-6">
                  ...
                  <span class="text-gray-500">Objectif: 1 000 €</span>
                </div>
                <a
                  href="#"
              ...
              <div class="p-6">
                <div class="flex justify-between items-baseline mb-2">
                  <h3 class="text-2xl font-bold text-gray-900">
                    <h3 class="font-title text-2xl font-bold text-gray-900">
                      Linh,
                      <span class="text-lg font-normal text-gray-500">7 ans</span>
                    </h3>
                </div>
                <p class="text-brand-blue font-semibold text-sm mb-4">
                  📍 Vietnam • Traitement antibiotique lourd
                </p>
                <p class="text-gray-600 mb-6 line-clamp-3">
                  Atteinte d'une infection respiratoire aiguë, Linh est sous
                  assistance. Ses parents, agriculteurs, ont épuisé leurs
                  économies. Elle a besoin de médicaments onéreux d'urgence.
                </p>
                <div class="w-full bg-gray-200 rounded-full h-2 mb-2">
                  <div
                    class="bg-brand-blue h-2 rounded-full"
                ...
                <div class="flex justify-between text-sm font-semibold mb-6">
                  ...
                  <span class="text-gray-500">Objectif: 200 €</span>
                </div>
                <a
                  href="#"
                  class="block text-center w-full bg-white border-2 border-brand-red text-brand-red font-semibold py-2 rounded-xl hover:bg-brand-red hover:text-white transition">
              ...
              <div class="p-6">
                <div class="flex justify-between items-baseline mb-2">
                  <h3 class="text-2xl font-bold text-gray-900">
                    <h3 class="font-title text-2xl font-bold text-gray-900">
                      Kamal,
                      <span class="text-lg font-normal text-gray-500">2 ans</span>
                    </h3>
                </div>
                <p class="text-brand-blue font-semibold text-sm mb-4">
                  📍 Madagascar • Réanimation néonatale
                </p>
                <p class="text-gray-600 mb-6 line-clamp-3">
                  Né grand prématuré, le petit Kamal se bat pour respirer dans un
                  service sous-équipé. Chaque jour d'incubation coûte de l'argent
                  que l'hôpital ne peut plus avancer.
                </p>
                <div class="w-full bg-gray-200 rounded-full h-2 mb-2">
                  <div
                    class="bg-brand-blue h-2 rounded-full"
                ...
                <div class="flex justify-between text-sm font-semibold mb-6">
                  ...
                  <span class="text-gray-500">Objectif: 500 €</span>
                </div>
                <a
                  href="#"
                  class="block text-center w-full bg-white border-2 border-brand-red text-brand-red font-semibold py-2 rounded-xl hover:bg-brand-red hover:text-white transition">
      ...
      <!-- ========================================== -->
      <section id="impact" class="bg-brand-blue py-16 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div class="text-4xl md:text-5xl font-extrabold mb-2">1 240</div>
              <div class="text-brand-blue-100 font-medium">
                Enfants soignés depuis 2020
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <div class="text-brand-blue-100 font-medium">
                Des dons reversés au médical*
              </div>
            </div>
            <div>
              <div class="text-4xl md:text-5xl font-extrabold mb-2">24h</div>
              <div class="text-brand-blue-100 font-medium">
                Délai d'intervention moyen
              </div>
            </div>
          </div>
          <p class="text-center text-xs opacity-60 mt-10">
            *Nos frais de fonctionnement sont couverts par des mécènes privés.
          </p>
        </div>
      </section>
    ...
    <footer class="bg-gray-900 text-gray-400 py-12">
      <div
        ...
        <div>
          <h4 class="font-title text-white font-semibold mb-4">Liens rapides</h4>
          <ul class="space-y-2 text-sm">
            <li>
              <a href="#" class="hover:text-white transition">Faire un don</a>
            </li>
            <li>
              <a href="#" class="hover:text-white transition">Bénévolat</a>
            </li>
            <li>
        ...
        <div>
          <h4 class="font-title text-white font-semibold mb-4">Contact</h4>
          <ul class="space-y-2 text-sm">
            <li>12 rue de l'Espoir, 75000 Paris</li>
            <li>contact@ilot-calins.org</li>
    ...
    <div class="fixed bottom-0 left-0 w-full z-40 flex flex-row shadow-[0_-4px_15px_rgba(0,0,0,0.1)] md:hidden">
      <button id="open-bottom-menu" class="flex-1 py-4 bg-white text-gray-800 font-bold text-lg border-r border-gray-100 hover:bg-gray-50 focus:outline-none">
        Menu
      </button>
      <a href="#don" class="flex-1 flex items-center justify-center py-4 bg-brand-red text-white font-bold text-lg hover:bg-brand-redHover focus:outline-none transition">
        Faire un don
      </a>
    </div>
    ...
    <div id="mobile-bottom-sheet" class="fixed inset-0 z-50 hidden md:hidden">
      <div id="mobile-overlay" class="absolute inset-0 bg-black/40 opacity-0 transition-opacity duration-300"></div>
      <div id="mobile-menu-content" class="absolute bottom-0 left-0 w-full bg-white rounded-t-3xl shadow-2xl transform translate-y-full transition-transform duration-300">
        <div class="flex justify-center items-center p-6 border-b border-gray-100 relative">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/lilotCalinsLogo.png" alt="Logo L'îlot Câlins" class="h-16 w-auto" />
          <button id="close-bottom-menu" class="absolute right-6 p-2 text-gray-500 hover:text-brand-red focus:outline-none bg-gray-100 rounded-full transition">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
            </svg>
          </button>
        </div>
        <div class="flex flex-col px-6 py-6 space-y-4 text-xl font-medium">
          <a href="#mission" class="block py-3 hover:bg-brand-blue/5 rounded-xl px-4 transition cursor-pointer text-gray-700 hover:text-brand-blue">Notre Mission</a>
          <a href="#enfants" class="block py-3 hover:bg-brand-blue/5 rounded-xl px-4 transition cursor-pointer text-gray-700 hover:text-brand-blue">Les Enfants</a>
          <a href="#impact" class="block py-3 hover:bg-brand-blue/5 rounded-xl px-4 transition cursor-pointer text-gray-700 hover:text-brand-blue">Notre Impact</a>
        </div>
      </div>
    </div>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", () => {
        ...
        if (openBtn && closeBtn) {
          ...
          // Permet de fermer le panneau automatiquement lorsqu'un lien est cliqué
